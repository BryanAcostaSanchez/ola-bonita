...
begin
  ...
  insert into public.sales (customer_id, subtotal_cents, discount_cents, status, total_cents, created_by) values (v_customer_id, v_total, 0, 'completed', v_total, auth.uid()) returning id into v_sale_id;
